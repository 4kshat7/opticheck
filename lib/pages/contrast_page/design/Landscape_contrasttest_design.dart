...
class ContrastTestLandscape extends StatefulWidget {
  const ContrastTestLandscape({super.key});

  @override
  State<ContrastTestLandscape> createState() => _ContrastTestLandscapeState();
}

class _ContrastTestLandscapeState extends State<ContrastTestLandscape> {
  @override
  void initState() {
    super.initState();
    final provider =
  ...
  Widget build(BuildContext context) {
    return Consumer<BluetoothConnectionProvider>(
      ...
      double referenceDistance = 65.0;
      double referenceSize = calculateIconSize(context) * 2;
