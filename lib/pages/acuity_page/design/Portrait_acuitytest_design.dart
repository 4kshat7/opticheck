...
class AcuityTestPortrait extends StatefulWidget {
  @override
  State<AcuityTestPortrait> createState() => _AcuityTestPortraitState();
}

class _AcuityTestPortraitState extends State<AcuityTestPortrait> {
  @override
  void initState() {
    super.initState();
    final provider =
